...
```bash
# Get hospital dashboard with real-time stats
curl -X GET https://api.example.com/hospitals/hospital-uuid/dashboard
```

### Example 4: Predict Bed Demand

```bash
# Get ML prediction for bed demand
curl -X POST https://api.example.com/ml/predict/hospital-uuid \
